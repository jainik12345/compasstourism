...
const HomeCertificate = () => {
  ...
  return (
    <div className='bg-gray-100'>
      <div className="container mx-auto max-w-screen-xl flex lg:flex-row flex-col items-center py-20 md:px-10 px-5">
        <div className="section lg:w-1/2 w-full text-center p-5 flex flex-col items-center justify-center">
          <h6 className="font-semibold text-orange-color mb-1 text-2xl">AWARDS &</h6>
