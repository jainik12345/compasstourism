  ...
  return (
    ...
    <>
      ...
      <div className="FAQ-cont gap-3 flex flex-col ">
        ...
        <h2 className="text-[1.5rem] font-semibold text-orange-color mb-4">Itinerary</h2>

        {
          ...
          FaqData.map((Val, Idx) => {
            ...
            return (
              ...
              <div className="fact-cont relative border border-gray-400 md:w-[65%] rounded-sm  p-2 select-none"
                ...
                <div className="faq-title flex justify-between items-center transition-all duration-75 ease-in-out" >
                  ...
                  <h3 className="text-lg font-semibold text-gray-800 flex items-center gap-4"><FaChevronUp size={30} className={`bg-gray-300 p-2 rounded-full transition-transform duration-500 ${openIndex === Idx ? 'rotate-[180deg]' : ''}`}/>
                    {Val.FaqTitle}
                  </h3>
