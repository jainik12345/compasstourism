  ...
  return (
    ...
    <>
      ...
      <div className="section">
        ...
        <div className="container max-w-screen-xl mx-auto px-10 py-10 flex flex-col gap-10 ">


          <div className="flex justify-between items-center px-5">

            <h2 className="text-[2rem]">Stay in touch</h2>
            <h2>+91 83476 22244</h2>

          </div>


          <div className="flex justify-between gap-10 text-center">
            <div className="flex flex-row gap-5 p-10 relative items-start group w-1/2  rounded-2xl shadow-md/50  transition-all duration-300 ease-in">
              ...
              <div className="flex flex-col gap-5 justify-center ">
                <h2 className="text-black font-semibold text-[1.5rem] group-hover:text-white">Head office - Ahmedabad</h2>
            ...
            <div className="flex flex-row gap-5 p-10 relative items-start group w-1/2   rounded-2xl shadow-md/50  transition-all duration-300 ease-in">
              ...
              <div className="flex flex-col gap-5 justify-center ">
                <h2 className="text-black font-semibold text-[1.5rem] group-hover:text-white">Branch office - Gandhinagar</h2>
