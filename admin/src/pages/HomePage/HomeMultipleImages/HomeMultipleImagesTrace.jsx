...
const HomeMultipleImagesTrace = () => {
  ...
  const fetchTrashedData = async () => {
    try {
      const res = await axios.get(`${BE_URL}/homeMultipleImages/trashed`);
  ...
  const handleRestore = async (id) => {
    try {
      await axios.patch(`${BE_URL}/homeMultipleImages/restore/${id}`);
...
export default HomeMultipleImagesTrace;
